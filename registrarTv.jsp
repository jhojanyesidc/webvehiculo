<%-- 
    ...
    Created on : 2/04/2025, 10:18:59 PM
    Author     : wcastro
--%>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
                                                                                    <form action="${ctx}/tipovehiControlador" method="post" class="form-horizontal">
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                                ID Tipo Vehiculo
                                                                                            </label>
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtidtv" value="" placeholder="ID del Tipo Vehiculo" />
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtnomtv" value="" placeholder="Nombre del Tipo Vehiculo" />
                                                                                            </div>
                                                                                        </div>
