<%-- 
    ...
    Created on : 20/04/2025, 10:27:00 AM
    Author     : wcastro
--%>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="assets/images/avatars/fotowc.jpg" alt="Wilcas Photo" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div>
                                                                                    <form action="${ctx}/vehiControlador" method="post" class="form-horizontal">
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                                Placa
                                                                                            </label>
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtplaca" value="" placeholder="Placa del Vehículo" />
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtmarca" value="" placeholder="Marca del Vehículo" />
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtmatricula" value="" placeholder="Referencia del Vehículo" />
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="txtmodelo" value="" placeholder="Modelo del Vehículo" />
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <!--<input type="text" name="txtidtv" value="" placeholder="ID del Tipo de Vehiculo" />  -->
                                                                                                <select name="txtidtv">
                                                                                        ...
                                                                                        <div>
                                                                                            <!--mesaje para validar que se registre el dato-->
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							Barner Acosta Ramirez &copy; SoBar-2026
						</span>
