<%-- 
    Document   : listarVehi
    Created on : 2/04/2025, 02:00:23 PM
    Author     : wcastro
--%>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="assets/images/avatars/fotowc.jpg" alt="Barner Photo" />
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Gestión completa de vehículos registrados
								</small>
							</h1>
						</div><!-- /.page-header -->
									...
									<div class="col-xs-12">
										<div class="clearfix">
											<div class="pull-right tableTools-container">
												<div class="ColVis btn-group" data-toggle="buttons">
													<a href="${ctx}/registrarVehi.jsp" class="btn btn-success btn-sm">
										...
										<div class="table-header">
											Resultados para "Lista de Vehículos"
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="hidden-480">Tipo de Vehículo</th>
														<th>Acciones</th>
													</tr>
												</thead>
												...
												<tbody>
													...
													%>
															<tr>
																...
																<td>
																	<a href="${ctx}/ver_vehiculo.jsp?placa=<%= rs.getString("placa") %>">
																		<%= rs.getString("placa") %>
																	</a>
																</td>
																<td><%= rs.getString("marca") %></td>
																<td class="hidden-480"><%= rs.getString("referencia") %></td>
																...
																<td>
																	<div class="hidden-sm hidden-xs btn-group">
																		...
																		<a href="${ctx}/editar_vehiculo.jsp?placa=<%= rs.getString("placa") %>"
																		   class="btn btn-xs btn-info"
																		   title="Editar vehículo">
																			<i class="ace-icon fa fa-pencil bigger-120"></i>
																		</a>

																		<a href="${ctx}/eliminar_vehiculo.jsp?placa=<%= rs.getString("placa") %>"
																		   class="btn btn-xs btn-danger"
																		   title="Eliminar vehículo"
																		   onclick="return confirm('¿Está seguro que desea eliminar este vehículo?');">
																	...
																	<div class="hidden-md hidden-lg">
																		<div class="inline pos-rel">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																				<li>
																					<a href="${ctx}/ver_vehiculo.jsp?placa=<%= rs.getString("placa") %>"
																					   class="tooltip-info" data-rel="tooltip" title="Ver">
																						<span class="blue">
																							<i class="ace-icon fa fa-eye bigger-120"></i>
																						</span>
																					</a>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Barner</span>
							Acosta Ramirez &copy; 2025
						</span>
